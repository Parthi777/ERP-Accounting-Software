...
export const PERMISSIONS = [
  ...
  { code: 'inventory.stock.approve', module: 'inventory', description: 'Approve or reject stock adjustments submitted by someone else' },
  ...
  { code: 'hr.payroll.run', module: 'hr', description: 'Prepare, post and pay monthly payroll', sensitive: true },
  ...
  { code: 'loans.view', module: 'accounting', description: 'View loans and their statements' },
  { code: 'loans.manage', module: 'accounting', description: 'Record loans, disbursements and repayments' },
  ...
  { code: 'gst.notes.manage', module: 'gst', description: 'Issue and cancel credit and debit notes' },
  { code: 'gst.itc.manage', module: 'gst', description: 'Reverse and re-claim input tax credit' },
  { code: 'gst.returns.prepare', module: 'gst', description: 'Import GSTR-2B and prepare GST returns' },
  { code: 'gst.returns.file', module: 'gst', description: 'Sign off and record the filing of GST returns' },
